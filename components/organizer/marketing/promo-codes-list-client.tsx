...
export type PromoCodesListClientProps = {
  promoCodes:
...
type PromoCodeStatusPresentation = {
  label: string;
  className: string;
  icon:
    typeof Check;
  ...
  return (
    <div className="flex min-h-[360px] flex-col items-center justify-center rounded-2xl border border-dashed border-white/[0.09] bg-white/[0.018] px-6 text-center">
      ...
      <p className="mt-2 max-w-md text-sm leading-6 text-neutral-500">
        Créez un code promo ou modifiez les filtres pour afficher les promotions existantes.
      </p>
    </div>
  );
}

function PromoCodeActions({
  promoCode,
  menuOpen,
  onToggleMenu,
  onCloseMenu,
  ...
  onViewPromoCode?:
    PromoCodesListClientProps["onViewPromoCode"];

  onEditPromoCode?:
    PromoCodesListClientProps["onEditPromoCode"];

  onDuplicatePromoCode?:
    PromoCodesListClientProps["onDuplicatePromoCode"];

  onStatusChange?:
    PromoCodesListClientProps["onStatusChange"];

  onDeletePromoCode?:
    PromoCodesListClientProps["onDeletePromoCode"];
}) {
  return (
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <div className="mt-3 flex items-center gap-2">
            ...
            <h3 className="truncate text-base font-black tracking-[0.05em] text-white">
              {
                promoCode.code
              }
            </h3>
...
export default function PromoCodesListClient({
  ...
  return (
    <section
      aria-labelledby="promo-codes-list-title"
      className={joinClassNames(
      ...
      <div className="flex flex-col gap-2 border-b border-white/[0.07] p-4 sm:flex-row sm:items-end sm:justify-between sm:p-5">
        <div className="min-w-0">
          ...
          <p className="mt-1 text-xs leading-5 text-neutral-500 sm:text-sm">
            Consultez les utilisations, remises accordées et revenus attribués.
          </p>
        </div>
                        ...
                        <td className="border-b border-white/[0.055] px-3 py-4">
                          <div className="min-w-[150px]">
                            <button
                              ...
                              className="flex max-w-full items-center gap-2 text-left text-sm font-black tracking-[0.06em] text-white hover:text-emerald-300"
                            >
                            ...
                            <button
                              ...
                              className="mt-2 inline-flex items-center gap-1.5 rounded-lg border border-white/[0.07] bg-white/[0.025] px-2 py-1 text-[10px] font-bold text-neutral-500 hover:border-emerald-400/20 hover:bg-emerald-400/[0.06] hover:text-emerald-300"
                            >
                              {copiedPromoCodeId ===
                              promoCode.id ? (
