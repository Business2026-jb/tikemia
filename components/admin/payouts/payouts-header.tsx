...
import ExportPayoutsButton, {
  type PayoutExportFilters,
} from "./export-payouts-button";
    ...
    <header className="rounded-2xl border border-white/[0.08] bg-[#071019] p-5 sm:p-6">
      <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
        <div className="flex min-w-0 items-start gap-4">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-amber-400/20 bg-amber-400/[0.08] text-amber-300">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-neutral-500">
              Examinez les demandes des organisateurs, validez les retraits,
              refusez les dossiers non conformes ou demandez des informations
              complémentaires.
            </p>
          </div>
        </div>
