...
export default function CancelMarketingDialog({
  campaign,
  open,
  onClose,
  onSuccess,
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center bg-black/80 p-4 backdrop-blur-sm">
      ...
      <div className="relative z-10 w-full max-w-lg rounded-[24px] border border-red-400/15 bg-[#070b0e] p-5 shadow-2xl sm:p-6">
        ...
        <h2 className="mt-5 text-xl font-black text-white">Annuler la campagne</h2>
        <p className="mt-2 text-sm leading-6 text-neutral-500">La campagne sera définitivement archivée et ne sera plus diffusée.</p>
