...
export default function SuspendMarketingDialog({
  campaign,
  open,
  onClose,
  onSuccess,
  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center bg-black/80 p-4 backdrop-blur-sm">
      ...
      <div className="relative z-10 w-full max-w-lg rounded-[24px] border border-sky-400/15 bg-[#070b0e] p-5 shadow-2xl sm:p-6">
        ...
        <h2 className="mt-5 text-xl font-black text-white">Suspendre la campagne</h2>
        <p className="mt-2 text-sm leading-6 text-neutral-500">La diffusion sera arrêtée immédiatement jusqu’à une nouvelle décision.</p>
        ...
        <div className="mt-6 flex justify-end gap-2">
          ...
          <button
            ...
            onClick={() => void submit()}
            disabled={!canSubmit}
            className="inline-flex h-11 items-center gap-2 rounded-xl bg-sky-500 px-5 text-sm font-black text-white disabled:opacity-40"
          >
            {submitting ? (
