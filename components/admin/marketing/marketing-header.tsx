...
import ExportMarketingButton, {
  type MarketingExportFilters,
} from "./export-marketing-button";
    ...
    <header className="rounded-2xl border border-white/[0.08] bg-[#071019] p-5 sm:p-6">
      <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
        <div className="flex min-w-0 items-start gap-4">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-neutral-500">
              Contrôlez les campagnes créées par les organisateurs,
              leurs périodes, budgets, priorités, performances et statuts.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-start gap-2">
          ...
          <ExportMarketingButton filters={filters} />
        </div>
      </div>
    </header>
  );
