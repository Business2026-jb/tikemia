    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/75 p-4 backdrop-blur-sm">
      ...
      <div className="relative z-10 w-full max-w-lg rounded-[24px] border border-red-400/15 bg-[#070b0e] p-5 shadow-2xl sm:p-6">
        ...
        <p className="mt-2 text-sm leading-6 text-neutral-500">
          Cette action met fin à l’abonnement et notifie automatiquement l’organisateur.
        </p>
        ...
        <label className="mt-4 flex cursor-pointer items-start gap-3 rounded-xl border border-white/[0.07] bg-white/[0.02] p-4">
          ...
          <span className="text-sm leading-6 text-neutral-400">
            Désactiver également le renouvellement automatique.
          </span>
        </label>
