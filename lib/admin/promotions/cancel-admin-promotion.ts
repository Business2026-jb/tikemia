...
export async function cancelAdminPromotion(input: {
  promotionId: string;
  adminId: string;
  reason: string;
  ...
  return prisma.$transaction(async (tx) => {
    ...
    const allowedStatuses: EventBoostStatus[] = [EventBoostStatus.ACTIVE, EventBoostStatus.SCHEDULED, EventBoostStatus.PAUSED];
    ...
    await createPromotionAuditLog({
      ...
      newStatus: EventBoostStatus.CANCELLED,
      reason,
