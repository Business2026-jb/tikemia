...
export type SendMarketingSuspendedEmailInput = Readonly<{
  to: string;
...
export async function sendMarketingSuspendedEmail(
  input: SendMarketingSuspendedEmailInput,
): Promise<MarketingEmailResult> {
  ...
  return sendMarketingEmail({
    to: input.to,
    subject: `Campagne marketing suspendue — ${campaignName}`,
    heading: `Bonjour ${organizerName}, votre campagne a été suspendue`,
    introduction:
      "L’administration Tikemia a suspendu temporairement votre campagne marketing. Sa diffusion est arrêtée jusqu’à une éventuelle réactivation.",
    rows: [
      ["Campagne", campaignName],
      ["Référence", campaignId],
      ["Événement", eventTitle],
    ],
    notice: `Motif de suspension : ${reason}`,
    noticeTone: "warning",
