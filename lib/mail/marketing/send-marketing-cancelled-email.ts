...
export type SendMarketingCancelledEmailInput = Readonly<{
  to: string;
...
export async function sendMarketingCancelledEmail(
  input: SendMarketingCancelledEmailInput,
): Promise<MarketingEmailResult> {
  ...
  return sendMarketingEmail({
    to: input.to,
    subject: `Campagne marketing annulée — ${campaignName}`,
    heading: `Bonjour ${organizerName}, votre campagne a été annulée`,
    introduction:
      "L’administration Tikemia a annulé et archivé votre campagne marketing. Elle ne sera plus diffusée sur la plateforme.",
    rows: [
      ["Campagne", campaignName],
      ["Référence", campaignId],
      ["Événement", eventTitle],
    ],
    notice: `Motif d’annulation : ${reason}`,
    noticeTone: "danger",
