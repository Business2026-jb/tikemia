  ...
  return (
    <main className="min-h-full w-full bg-[#030708] p-4 text-white sm:p-5 lg:p-6">
      <div className="space-y-4">
        <div className="rounded-2xl border border-white/[0.08] bg-[#071019] p-5 sm:p-6">
          <div className="flex items-start gap-4">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-3 h-8 w-72 max-w-full animate-pulse rounded bg-white/[0.07]" />
              <div className="mt-3 h-4 w-[520px] max-w-full animate-pulse rounded bg-white/[0.05]" />
            </div>
          </div>
        </div>
        ...
        <div className="h-36 animate-pulse rounded-2xl border border-white/[0.06] bg-[#071019]" />
