...
export default function AdminEventsError({
  error,
  reset,
}: AdminEventsErrorProps) {
  useEffect(() => {
    console.error(
      "[ADMIN_EVENTS_PAGE_ERROR]",
      error,
    );
  }, [error]);

  return (
    <div className="flex min-h-[70vh] w-full items-center justify-center bg-[#03080d] p-4 text-white sm:p-6">
      <div className="w-full max-w-lg rounded-[24px] border border-red-400/15 bg-[#07111d] p-6 text-center shadow-2xl sm:p-8">
        ...
        <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-neutral-500">
          ...
          Vous pouvez réessayer sans quitter l’administration.
        </p>
