...
export default function AdminPayoutsError({
  error,
  reset,
}: AdminPayoutsErrorProps) {
  useEffect(() => {
    console.error(
      "[ADMIN_PAYOUTS_PAGE_ERROR]",
      error,
    );
  }, [
    error,
    ...
    <div className="flex min-h-[70vh] w-full items-center justify-center bg-[#030708] p-4 text-white sm:p-6">
      <div className="w-full max-w-lg rounded-[24px] border border-red-400/15 bg-[#071019] p-6 text-center shadow-2xl sm:p-8">
        ...
        <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-neutral-500">
          Une erreur est survenue pendant le chargement des demandes de retrait.
          Vous pouvez relancer la page sans quitter l’administration.
        </p>
