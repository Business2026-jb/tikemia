...
import { cancelAdminCoupon } from "@/lib/admin/coupons/cancel-admin-coupon";
import { serializeAdminCouponError } from "@/lib/admin/coupons/admin-coupon-errors";
import { requireAdmin } from "@/lib/admin/require-admin";
import { sendCouponCancelledEmail } from "@/lib/mail/coupons/send-coupon-cancelled-email";
...
export async function POST(
  ...
  try {
    ...
    try {
      await sendCouponCancelledEmail({
        to:
      ...
      console.error(
        "[ADMIN_COUPON_CANCELLED_EMAIL_ERROR]",
        emailError,
      );
    }
    ...
    return jsonResponse({
      ...
      message:
        "Le code promo a été annulé et archivé.",
