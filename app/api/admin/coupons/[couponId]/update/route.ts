...
import { updateAdminCoupon } from "@/lib/admin/coupons/update-admin-coupon";
import { requireAdmin } from "@/lib/admin/require-admin";
import { sendCouponUpdatedEmail } from "@/lib/mail/coupons/send-coupon-updated-email";
  ...
  try {
          ...
          error: {
            ...
            message:
              parsed.error
                .issues[0]
                ?.message ||
              "Les nouvelles règles du code promo sont invalides.",
    ...
    const result =
      await updateAdminCoupon({
        ...
        maximumDiscount:
          parsed.data.maximumDiscount,

        maximumUses:
          parsed.data.maximumUses,
    ...
    try {
      ...
      console.error(
        "[ADMIN_COUPON_UPDATED_EMAIL_ERROR]",
        emailError,
      );
    }
