...
import { extendAdminCoupon } from "@/lib/admin/coupons/extend-admin-coupon";
import { requireAdmin } from "@/lib/admin/require-admin";
import { sendCouponExtendedEmail } from "@/lib/mail/coupons/send-coupon-extended-email";
...
export async function POST(
  ...
  try {
    ...
    try {
      ...
      console.error(
        "[ADMIN_COUPON_EXTENDED_EMAIL_ERROR]",
        emailError,
      );
    }
