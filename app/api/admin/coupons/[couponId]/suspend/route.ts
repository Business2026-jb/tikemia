...
import { suspendAdminCoupon } from "@/lib/admin/coupons/suspend-admin-coupon";
import { requireAdmin } from "@/lib/admin/require-admin";
import { sendCouponSuspendedEmail } from "@/lib/mail/coupons/send-coupon-suspended-email";
...
export async function POST(
  ...
  try {
    ...
    try {
      await sendCouponSuspendedEmail({
        to:
      ...
      console.error(
        "[ADMIN_COUPON_SUSPENDED_EMAIL_ERROR]",
        emailError,
      );
    }
