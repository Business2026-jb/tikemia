...
import {
  moderateAdminEvent,
} from "@/lib/admin/events/moderate-admin-event";
import {
  requireAdmin,
...
export async function PATCH(
  ...
  try {
          ...
          error: {
            ...
            message:
              parsed.error
                .issues[0]
                ?.message ??
              "Les informations de modération sont invalides.",
    ...
    return jsonResponse({
      ...
      message:
        "L’action de modération a été appliquée.",
