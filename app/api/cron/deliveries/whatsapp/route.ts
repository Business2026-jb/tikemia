...
} from "@/lib/deliveries/process-whatsapp-deliveries";
import {
  getPaymentError,
...
async function execute(
  ...
  try {
    ...
    if (
      ...
      console.error(
        "[CRON_WHATSAPP_DELIVERIES_CONFIGURATION_ERROR]",
        {
          message:
    ...
    const paymentError =
      getPaymentError(
        error,
        {
          ...
          message:
            "Impossible de traiter les livraisons WhatsApp.",
    ...
    console.error(
      "[CRON_WHATSAPP_DELIVERIES_ERROR]",
      getPaymentErrorLogContext(
        paymentError,
      ),
    );
        ...
        error: {
          ...
          message:
            paymentError.exposeMessage
              ...
              : "Le traitement des livraisons WhatsApp a échoué.",
        },
      },
      paymentError.status,
    );
