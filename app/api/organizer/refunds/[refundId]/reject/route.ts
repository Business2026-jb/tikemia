...
import {
  ...
  rejectRefundRequest,
} from "@/lib/organizer/refunds/reject-refund-request";
import {
  prisma,
} from "@/lib/prisma";
    ...
    .object({
      reason:
        z
          ...
          .max(
            1_500,
            "Le motif du refus ne peut pas dépasser 1500 caractères.",
          ),
    })
    .strict();
    ...
    return jsonResponse(
      {
        ...
        error: {
          ...
          message:
            "Impossible de refuser cette demande de remboursement pour le moment.",
        },
      },
      500,
    );
